...
# def test_model(plane, dataset, split="val"):
#     """학습된 모델의 성능 테스트"""
#     best_model_path = BEST_MODEL_PATH_TEMPLATE.format(plane=plane, dataset=dataset)
#     experiment_name = f"test/{plane}_{dataset}"
...
#         save_conf=True,
#         conf=0.25 if split == "val" else None,
#         rect=True if split == "val" else False  # rect 파라미터 설정 가능
#     )
...
#     test_model(args.plane, args.dataset, args.split)
...
# if __name__ == "__main__":
#     test_model("axial", "base", split="val")
